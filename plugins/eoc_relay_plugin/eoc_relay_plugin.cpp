...
namespace eosio {
   ...
   static appbase::abstract_plugin& _eoc_relay_plugin = app().register_plugin<eoc_relay_plugin>();
      ...
      void eoc_relay_plugin::set_program_options(options_description&, options_description& cfg) {
       ...
       ("eoc-relay-peer-contract", bpo::value<string>()->default_value("eosioeocsicp"), "The peer icp contract account name")
       ("eoc-relay-local-contract", bpo::value<string>()->default_value("eosioeocsicp"), "The local icp contract account name")
       ("eoc-relay-signer", bpo::value<string>()->default_value("eoseocsrelay@active"), "The account and permission level to authorize icp transactions on local icp contract, as in 'account@permission'")
