...
const static uint64_t system_account_name    = N(lemon);
const static uint64_t null_account_name      = N(lemon.null);
const static uint64_t producers_account_name = N(lemon.prods);
...
const static uint64_t eosio_auth_scope       = N(lemon.auth);
const static uint64_t eosio_all_scope        = N(lemon.all);

const static uint64_t active_name = N(active);
const static uint64_t owner_name  = N(owner);
const static uint64_t eosio_any_name = N(lemon.any);
const static uint64_t eosio_code_name = N(lemon.code);
