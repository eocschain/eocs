...
#define SET_APP_HANDLER( receiver, contract, action) \
   ...
   SET_APP_HANDLER( lemonc, eosio, newaccount );
   SET_APP_HANDLER( lemonc, eosio, setcode );
   SET_APP_HANDLER( lemonc, eosio, setabi );
   SET_APP_HANDLER( lemonc, eosio, updateauth );
   SET_APP_HANDLER( lemonc, eosio, deleteauth );
   SET_APP_HANDLER( lemonc, eosio, linkauth );
   SET_APP_HANDLER( lemonc, eosio, unlinkauth );
/*
...
*/
   ...
   SET_APP_HANDLER( lemonc, eosio, canceldelay );
